...
class AuthClient
{
     ...
     */
    public function mintUpsellToken(string $clientId, string $clientSecret, ?int $parentId = null, ?int $businessId = null, string $access = 'public', ?int $contactMappingId = null, int $expiresIn = 300, ?string $adminScope = null): array
    {
        if ($clientId === '' || $clientSecret === '') {
