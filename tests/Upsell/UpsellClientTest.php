...
class UpsellClientTest extends TestCase
{
    ...
    public function testAdminListPlacementsScopesToOneOutlet(): void
    {
        $this->stub->pushJson(200, ['placements' => []]);
        $this->upsell->adminListPlacements(['parentId' => 5, 'businessId' => 7175]);
        $this->assertSame('https://api.test/v1/upsell/admin/placements?parentId=5&businessId=7175', $this->stub->lastCall()['url']);
    }
